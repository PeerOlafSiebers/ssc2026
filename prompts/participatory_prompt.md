=============================================
# PARTICIPATORY DRIVEN RAT-RS QUESTION SUITES
=============================================
...
## 4. TEMPLATE — PARTICIPATORY DRIVEN RAT-RS QUESTION SUITES
...
Q2.1  Who did you recruit for the participatory process and why?
Q2.2  Describe the participatory process (e.g. environment, context, questions that were asked), including anything else that might have influenced the output (e.g. fire alarm during the participatory session).
Q2.3  What are the key elements of the target system?
Q2.4  What procedures and methods did you use to conceptualise the target system key elements? Provide a comprehensive description about how you made use of the participatory process in the conceptualization of the target system key elements. Provide details about what other sources you utilised to conceptualise target system key elements (e.g. theory, previous model(s)).
Q2.5  Explain why a model element was added when this was not included in the target system
Q2.6  What elements of the target system were mapped into model elements? (distinguish (at least) between agents, environment, and relationships/interactions among any combination of these)
Q2.7  Explain why elements of the target system were included, excluded or changed in the model.
Q2.8  What procedures and methods did you use to conceptualise the target system elements as model elements? Provide a comprehensive description about how you made use of the participatory process in the conceptualization of the model elements. Provide details about what other sources you utilised to conceptualise model elements (e.g. use of a previous model).
